...
public class ERC721 extends Contract implements IERC721Metadata {
  ...
  private final UnsignedBigInteger ZERO = UnsignedBigInteger.valueOf(0);
  private final UnsignedBigInteger ONE = UnsignedBigInteger.valueOf(1);
  ...
  protected void
  _beforeTokenTransfer(Contract from, Contract to, UnsignedBigInteger tokenId) {
